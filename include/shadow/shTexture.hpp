...
// ---------- Shadow ----------
namespace sh{namespace texture
{
    class sh_Texture
    {
    public:
    ...
    public:
		...
		inline static void Create(std::string texture_reference, const char* file_location) { return Get().in_Create(texture_reference, file_location); };
	...
	private:
		//Internal functions
		void in_Create(std::string texture_reference, const char* file_location);
